...
def run_all_variations(i, lock, task_index, variation_count, results,
                       file_lock, tasks):
...
def main(argv):
    ...
    # multiprocessing for all_variations not supported for now
    run_all_variations(
        0, lock,
        task_index, variation_count, result_dict, file_lock, tasks
    )
