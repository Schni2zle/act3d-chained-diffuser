...
class TaskEnvironment(object):
    ...
    def step(self, action:Dict[str,np.ndarray]) -> Tuple[Observation, int, bool]:
    ...
    def get_demos(self, amount: int, live_demos: bool = False,
        ...
        if not live_demos:
            ...
            demos = self._get_live_demos(
                amount, callable_each_step, human_demos=human_demos, floating_cam = floating_cam, 
                                         viewpoint_env_bounds=viewpoint_env_bounds, max_attempts=max_attempts)
